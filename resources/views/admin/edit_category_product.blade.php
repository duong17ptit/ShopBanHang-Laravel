    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                @foreach($item_edit as $key => $edit_value)
                    ...
                    <form role="form" action="{{URL::to('/update-category-product/'.$edit_value->category_id)}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_product_status" class="form-control input-sm m-bot15">
                                <option value="0" <?php echo ($edit_value->category_status==0) ? 'selected' : '' ?>>Ẩn</option>
                                <option value="1"  <?php echo ($edit_value->category_status==1) ? 'selected' : '' ?> >Hiển thị</option>
